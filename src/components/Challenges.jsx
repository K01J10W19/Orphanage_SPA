                    ...
                    <div className="row g-4">
                        ...
                        <div className="col-md-4">
                            <div className="challenge-card shadow-lg rounded-4 overflow-hidden position-relative">
                                <img src="/assets/challenges_img01.webp" className="w-100 h-100 object-fit-cover" alt="Food Insecurity" />
                        ...
                        <div className="col-md-4">
                            <div className="challenge-card shadow-lg rounded-4 overflow-hidden position-relative">
                                <img src="/assets/challenges_img02.webp" className="w-100 h-100 object-fit-cover" alt="Education Access" />
                                <div className="challenge-overlay p-4 text-center">
                        ...
                        <div className="col-md-4">
                            <div className="challenge-card shadow-lg rounded-4 overflow-hidden position-relative">
                                <img src="/assets/challenges_img03.webp" className="w-100 h-100 object-fit-cover" alt="Healthcare Disparity" />
                                <div className="challenge-overlay p-4 text-center">
                        ...
                        <div className="col-md-4">
                            <div className="challenge-card shadow-lg rounded-4 overflow-hidden position-relative">
                                <img src="/assets/challenges_img04.webp" className="w-100 h-100 object-fit-cover" alt="Trauma" />
                                <div className="challenge-overlay p-4 text-center">
                        ...
                        <div className="col-md-4">
                            <div className="challenge-card shadow-lg rounded-4 overflow-hidden position-relative">
                                <img src="/assets/challenges_img05.webp" className="w-100 h-100 object-fit-cover" alt="Unsafe Living" />
                                <div className="challenge-overlay p-4 text-center">
                        ...
                        <div className="col-md-4">
                            <div className="challenge-card shadow-lg rounded-4 overflow-hidden position-relative">
                                <img src="/assets/challenges_img06.webp" className="w-100 h-100 object-fit-cover" alt="Vulnerability" />
                                <div className="challenge-overlay p-4 text-center">
